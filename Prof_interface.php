  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="../dashboard/index.html" class="b-brand text-primary">
        <img src="assets\images\logo-withoutBG.png" class="img-fluid logo-lg" alt="logo">
      </a>
    </div>
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="Prof_interface.php?page=unite" class="pc-link">
            <span class="pc-micon"><i class="ti ti-book"></i></span>
            <span class="pc-mtext">Unités d'enseignement</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="Prof_interface.php?page=note" class="pc-link">
