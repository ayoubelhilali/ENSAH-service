<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" action="traitement_note.php">
      ...
      <div class="form-group">
       ...
       <div> <?php 
          if($_SESSION['succes']==1) echo "<h4 style='color:green;'>Fichier importé avec succès.<h4>"  ;
          elseif($_SESSION['succes']==0)  echo "<h4 style='color:red;'>Impossible de lire le fichier.<h4>" ;
