...
$annees = $pdo->query("SELECT annee FROM affect_ue_prof ORDER BY annee DESC")->fetchAll();
...
<div class="container">
  ...
  if ($anneeSelectionnee) {
    $stmt = $pdo->prepare("
      SELECT u.unite_name, u.volume_cours, u.volume_td, u.volume_tp, a.annee, p.nom, p.prenom, p.CIN
      FROM affect_ue_prof a
      JOIN user p ON a.id_prof = p.user_ID
    ...
    <table class="styled-table">
      <thead>
        <tr>
          ...
          <th colspan="3">Charge horaire</th>
