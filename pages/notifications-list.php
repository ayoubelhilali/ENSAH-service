...
<head>
    <title>ENSAH services - Les notifications</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
...
<body data-pc-preset="preset-1" data-pc-direction="ltr" data-pc-theme="light">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Les notifications</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Les notifications</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="card table-card">
                        <div class="card-body">
                            ...
                            $notifications_query = "SELECT * FROM notifications ORDER BY date_time DESC";
                            $stmt = $pdo->prepare($notifications_query);
                            $stmt->execute();
                            $all_notifications = $stmt;
                            ?>
                            <!---------------------------------->
                                ...
                                <table class="table table-hover" id="pc-dt-simple">
                                    ...
                                    <tbody>
                                        ...
                                        while ($notification = $all_notifications->fetch(PDO::FETCH_ASSOC)) {
                                            if (
                                                $notification["type"] == "general" || ($notification["type"] == "personel" && $notification["id_user"] == $_SESSION["user"]["user_id"]) ||
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col">
                                                            <h6 class="mb-1">
                                                                <span><?= (strlen($notification['content']) > 50) ? substr(htmlspecialchars($notification['content'], ENT_QUOTES, 'UTF-8'), 0, 50) . ' . . .' : htmlspecialchars($notification['content'], ENT_QUOTES, 'UTF-8') ?></span>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </td>
                                                    ...
                                                    <ul class="list-inline me-auto mb-0">
                                                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip"
                                                            ...
                                                            <a href="#" class="avtar avtar-xs btn-link-secondary view-btn"
                                                                ...
                                                                data-notification_Head="<?= $notification['title']; ?>"
                                                                data-desc="<?= $notification['content']; ?>"
                                                                data-date="<?= $notification['date_time']; ?>">
                                                        ...
                                                        <?php if ($_SESSION['user']['role'] == 'admin') { ?>
                                                            <li class="list-inline-item align-bottom" data-bs-toggle="tooltip">
                                                                <a href="#" class="avtar avtar-xs btn-link-danger affect-btn"
                                                                    title="Supprimer la notification" data-bs-toggle="modal"
                                                                    data-bs-target="#ue-affect-modal"
                                                                    onclick="deleteNotif(<?= $notification['id_notification']; ?>)">
    ...
    <div class="modal fade" id="notification-modal" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="">
                <div class="modal-header border-0 pb-0">
                    <h5 class="mb-0">Détails de la notification</h5>
                                ...
                                <div class="card-body">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item px-0 pt-0">
                                            <p class="mb-1 text-muted">Titre de la notification</p>
    ...
    {
        global $pdo;
        $stmt = $pdo->prepare("DELETE FROM notifications WHERE id_notification = :notification_id");
    ...
    if (isset($_POST['delete_notification'])) {
        ...
        if (deleteNotif($notification_id)) {
            echo "<script>
              document.addEventListener('DOMContentLoaded', function() {
                const successMsg = document.querySelector('.success-msg');
                if (successMsg) {
                  successMsg.innerHTML = '<div class=\"alert alert-success\">notification supprimée avec succès.</div>';
                }
              });
              setTimeout(function() {
                const successMsg = document.querySelector('.success-msg');
        ...
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.view-btn').forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    const titre = button.getAttribute('data-notification_Head');
