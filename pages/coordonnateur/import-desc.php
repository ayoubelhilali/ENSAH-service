...
<head>
  <title>ENSAH services - Importer descriptif</title>
 <!-- [Meta] -->
 <meta charset="utf-8">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Importer descriptif</li>
              </ul>
            </div>
            <div class="col-md-12">
              <div class="page-header-title">
                <h2 class="mb-0">Importer descriptif</h2>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="card w-100">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="anonce_head" class="form-control form-control" placeholder="Titre de l'annonce">
                </div>
                <div class="form-group mb-0">
                  <label class="form-label" for="exampleTextarea">Text de l'annonce</label>
                  <textarea class="form-control" name="anonce_body" id="exampleTextarea" rows="3" placeholder="Entrer les details de l'annonce"></textarea>
                </div>
              </div>
              <div class="card-footer">
                <input type="submit" name="annoncer" class="btn btn-primary me-2" value="Annoncer">
