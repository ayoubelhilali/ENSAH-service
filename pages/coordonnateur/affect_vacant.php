...
<head>
    <title>ENSAH-service | les vacants</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover" id="pc-dt-simple">
                                    ...
                                    <tbody>
                                        <?php
                                        $units_query = "SELECT * FROM unite WHERE unite_resp IS NULL ORDER BY semestre,unite_ID";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col">
                                                            <h6 class="mb-1">
                                                                <?= "Dr. " . htmlspecialchars($resp_ue['nom'], ENT_QUOTES, 'UTF-8') . " " . htmlspecialchars($resp_ue['prenom'], ENT_QUOTES, 'UTF-8') ?>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </td>
