                ...
                <div class="col-sm-12">
                    <div class="card table-card">
                        <div class="card-body">
                            ...
                            $vacats_query = "SELECT * FROM vacataire V
                            JOIN user U ON V.user_ID = U.user_ID";
                            $stmt = $pdo->prepare($vacats_query);
                            $stmt->execute();
                            $all_vacats = $stmt;
                            $vacats = [];
                            while ($vacat = $all_vacats->fetch(PDO::FETCH_ASSOC)) {
                                $vacats[] = [
                                    'vacat_ID' => $vacat['vacat_ID'],
                                    'nom' => $vacat['nom'],
                                    'prenom' => $vacat['prenom'],
                                    'email' => $vacat['email']
                                ];
                            ...
                            $vacats_json = htmlspecialchars(json_encode($vacats), ENT_QUOTES, 'UTF-8');
                            ?>
