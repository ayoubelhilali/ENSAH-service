  ...
  <div class="auth-main">
    <div class="auth-wrapper v3">
      <div class="auth-form">
        ...
        <div class="card my-5">
          <form method="post" action="dist/dashboard/admin-dash.php" class="card-body">
            <div class="d-flex justify-content-between align-items-end mb-4">
              <h3 class="mb-0"><b>Login</b></h3>
              <a href="dist/pages/register.html" class="link-primary">Don't have an account?</a>
            </div>
            ...
            <div class="d-flex mt-1 justify-content-between">
              ...
              <a href="forgot-password.html" class="text-secondary f-w-400">Forgot Password?</a>
            </div>
        ...
        <div class="auth-footer row">
          <!-- <div class=""> -->
            <div class="col my-1">
              <p class="m-0">Copyright © <a href="#">2025 - Tous droits réservés</a></p>
            </div>
