...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '/ENSAH-service/assets/images/logo-withoutBG.png');
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '/ENSAH-service/assets/images/logo-withoutBG.png');
    }

    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '/ENSAH-service/assets/images/logo-withoutBG.png');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '/ENSAH-service/assets/images/logo-withoutBG.png');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '/ENSAH-service/assets/images/logo-withoutBG.png');
    }
